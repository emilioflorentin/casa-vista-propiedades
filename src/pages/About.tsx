    ...
    <div className="min-h-screen bg-gradient-to-br from-stone-50 to-stone-100">
      ...
      <section className="relative bg-gradient-to-br from-stone-300 via-stone-400 to-stone-500 text-white">
        ...
        <div className="relative container mx-auto px-6 py-24 text-center">
          ...
          <p className="text-xl md:text-2xl mb-12 text-stone-50 max-w-3xl mx-auto">{t("about.subtitle")}</p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 leading-relaxed mb-8">{t("about.story_p1")}</p>
              <p className="text-lg text-gray-600 leading-relaxed">{t("about.story_p2")}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">{t("about.values_desc")}</p>
          </div>
      ...
      <section className="py-20 bg-stone-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">{t("about.team_desc")}</p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <Card className="border-stone-200">
                ...
                <CardContent className="text-center">
                  <CardDescription className="text-gray-600">{t("about.sales_team.description")}</CardDescription>
                </CardContent>
              </Card>
              ...
              <Card className="border-stone-200">
                ...
                <CardContent className="text-center">
                  <CardDescription className="text-gray-600">{t("about.management_team.description")}</CardDescription>
                </CardContent>
              </Card>
              ...
              <Card className="border-stone-200">
                ...
                <CardContent className="text-center">
                  <CardDescription className="text-gray-600">{t("about.maintenance_team.description")}</CardDescription>
                </CardContent>
              </Card>
              ...
              <Card className="border-stone-200">
                ...
                <CardContent className="text-center">
                  <CardDescription className="text-gray-600">{t("about.renovation_team.description")}</CardDescription>
                </CardContent>
              </Card>
            </div>
          </div>
      ...
      <section className="py-16 bg-stone-600 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl mb-8 text-stone-100">{t("about.cta.description")}</p>

...
const Contact = () => {
  ...
  const handleEmailClick = () => {
    ...
    window.open("mailto:info@nazarihomes.com", "_self");
  };
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            <div className="h-96">
              <MapComponent location="Granada, España" title={t("contact.operation_area")} />
            </div>
                  ...
                  <div className="space-y-4">
                    ...
                    {showPrivacyError && (
                      <Alert variant="destructive">
                        <AlertDescription>{t("contact.privacy_error")}</AlertDescription>
                      </Alert>
                    )}

  ...
  <footer className="border-t border-border bg-card mt-16">
    <div className="container mx-auto px-6 py-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
      ...
      <div className="flex flex-col gap-2 text-sm">
        <Link to="/roomie-finder/publicar" className="text-primary hover:underline">Publicar habitación</Link>
        <Link to="/roomie-finder/mi-perfil" className="text-primary hover:underline">Mi perfil roomie</Link>
        <Link to="/roomie-finder/matches" className="text-primary hover:underline">Matches</Link>

          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/nazarihomes" target="_blank" rel="noopener noreferrer">
                <Instagram className="h-5 w-5 text-primary-foreground/70 hover:text-accent cursor-pointer transition-colors" />
              </a>
              <a href="https://www.tiktok.com/@nazari.homes" target="_blank" rel="noopener noreferrer">
                <svg className="h-5 w-5 text-primary-foreground/70 hover:text-accent cursor-pointer transition-colors" viewBox="0 0 24 24" fill="currentColor">

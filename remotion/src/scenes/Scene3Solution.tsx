      ...
      >
        {SWIPE_CARDS.map((card, i) => {
          ...
          return (
            ...
            >
              <div style={{ fontFamily: OSWALD, fontSize: isVertical ? 72 : 60, fontWeight: 700 }}>{card.rent}</div>
              <div style={{ fontFamily: INTER, fontSize: isVertical ? 28 : 24, opacity: 0.9, marginTop: 8 }}>/mes</div>
              <div
                style={{
                  marginTop: 32,
                  fontFamily: INTER,
